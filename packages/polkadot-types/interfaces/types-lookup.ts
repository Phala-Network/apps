...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PhalaPalletsComputeVaultPalletCall (339) */
  ...
  /** @name PhalaPalletsComputeWrappedBalancesPalletCall (340) */
  ...
  /** @name PhalaPalletsComputeBasePoolPalletCall (341) */
  ...
  /** @name PalletPhalaWorldNftSalePalletCall (371) */
  ...
  /** @name PalletPhalaWorldStatusType (374) */
  ...
  /** @name PalletPhalaWorldIncubationPalletCall (375) */
  ...
  /** @name KhalaParachainRuntimeOriginCaller (376) */
  ...
  /** @name CumulusPalletXcmOrigin (378) */
  ...
  /** @name PalletProxyProxyDefinition (390) */
  ...
  /** @name PalletProxyAnnouncement (394) */
  ...
  /** @name PalletVestingReleases (399) */
  ...
  /** @name PalletSchedulerScheduled (403) */
  ...
  /** @name PalletPreimageRequestStatus (406) */
  ...
  /** @name PolkadotPrimitivesV2UpgradeRestriction (412) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHrmpChannel (416) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHostConfiguration (417) */
  ...
  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (423) */
  interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemError (424) */
  ...
  /** @name PalletBalancesReleases (463) */
  ...
  /** @name PalletAuthorshipUncleEntryItem (468) */
  ...
  /** @name PalletAuthorshipError (470) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (473) */
  interface PalletCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletCollatorSelectionError (475) */
  ...
  /** @name SpCoreCryptoKeyTypeId (479) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (480) */
  ...
  /** @name PalletDemocracyReferendumInfo (500) */
  ...
  /** @name PalletDemocracyReferendumStatus (501) */
  ...
  /** @name PalletDemocracyVoteVoting (503) */
  ...
  /** @name PalletDemocracyDelegations (507) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (508) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (512) */
  ...
  /** @name PalletCollectiveVotes (514) */
  ...
  /** @name PalletCollectiveError (515) */
  ...
  /** @name PalletTreasuryProposal (516) */
  ...
  /** @name PalletLotteryLotteryConfig (524) */
  ...
  /** @name PalletElectionsPhragmenSeatHolder (534) */
  ...
  /** @name PalletElectionsPhragmenVoter (535) */
  ...
  /** @name PalletElectionsPhragmenError (536) */
  ...
  /** @name PalletChildBountiesChildBounty (540) */
  ...
  /** @name PalletChildBountiesChildBountyStatus (541) */
  ...
  /** @name PalletChildBountiesError (542) */
  ...
  /** @name SubbridgePalletsChainbridgePalletProposalVotes (545) */
  ...
  /** @name SubbridgePalletsChainbridgePalletProposalStatus (546) */
  ...
  /** @name SubbridgePalletsChainbridgePalletBridgeEvent (548) */
  ...
  /** @name SubbridgePalletsChainbridgePalletError (550) */
  ...
  /** @name SubbridgePalletsXcmbridgePalletError (551) */
  ...
  /** @name SubbridgePalletsXtransferPalletError (552) */
  ...
  /** @name PhalaPalletsMqPalletError (554) */
  ...
  /** @name PhalaPalletsRegistryPalletWorkerInfoV2 (556) */
  ...
  /** @name PhalaPalletsRegistryPalletKnownConsensusVersion (558) */
  interface PhalaPalletsRegistryPalletKnownConsensusVersion extends Struct {
    readonly version: u32;
    readonly count: u32;
  }

  /** @name PhalaPalletsRegistryPalletError (559) */
  ...
  /** @name PhalaPalletsComputeComputationPalletSessionInfo (560) */
  ...
  /** @name PhalaPalletsComputeComputationPalletWorkerState (561) */
  ...
  /** @name PhalaPalletsComputeComputationPalletBenchmark (562) */
  ...
  /** @name PhalaPalletsComputeComputationPalletSessionStats (563) */
  interface PhalaPalletsComputeComputationPalletSessionStats extends Struct {
    readonly totalReward: u128;
  }

  /** @name PhalaPalletsComputeComputationPalletError (564) */
  ...
  /** @name PhalaPalletsStakePoolPalletPoolInfo (565) */
  ...
  /** @name PhalaPalletsStakePoolPalletWithdrawInfo (568) */
  ...
  /** @name PhalaPalletsStakePoolPalletUserStakeInfo (570) */
  ...
  /** @name PhalaPalletsStakePoolPalletError (573) */
  type PhalaPalletsStakePoolPalletError = Null;

  /** @name PalletAssetsAssetDetails (574) */
  ...
  /** @name PalletAssetsAssetAccount (576) */
  ...
  /** @name PalletAssetsExistenceReason (577) */
  ...
  /** @name PalletAssetsApproval (579) */
  interface PalletAssetsApproval extends Struct {
    readonly amount: u128;
    readonly deposit: u128;
  }

  /** @name PalletAssetsAssetMetadata (580) */
  ...
  /** @name AssetsRegistryAssetRegistryInfo (583) */
  ...
  /** @name PhalaPalletsComputeStakePoolV2PalletError (589) */
  ...
  /** @name PhalaPalletsComputeVaultPalletError (590) */
  ...
  /** @name PhalaPalletsComputePoolProxy (597) */
  ...
  /** @name PhalaPalletsComputePoolProxyStakePool (598) */
  ...
  /** @name PhalaPalletsComputeBasePoolPalletBasePool (599) */
  ...
  /** @name PhalaPalletsComputeBasePoolPalletWithdrawInfo (601) */
  ...
  /** @name PhalaPalletsComputePoolProxyVault (602) */
  ...
  /** @name PhalaPalletsComputeBasePoolPalletError (603) */
  ...
  /** @name PalletUniquesCollectionDetails (604) */
  ...
  /** @name PalletUniquesItemDetails (606) */
  ...
  /** @name PalletUniquesCollectionMetadata (607) */
  ...
  /** @name PalletUniquesItemMetadata (608) */
  ...
  /** @name RmrkTraitsCollectionCollectionInfo (613) */
  ...
  /** @name RmrkTraitsNftRoyaltyInfo (616) */
  interface RmrkTraitsNftRoyaltyInfo extends Struct {
    readonly recipient: AccountId32;
    readonly amount: Permill;
  }

  /** @name RmrkTraitsResourceResourceInfo (618) */
  ...
  /** @name RmrkTraitsNftNftChild (621) */
  interface RmrkTraitsNftNftChild extends Struct {
    readonly collectionId: u32;
    readonly nftId: u32;
  }

  /** @name PhantomType (622) */
  interface PhantomType extends Vec<RmrkTraitsPropertyPropertyInfo> {}

  /** @name RmrkTraitsPropertyPropertyInfo (623) */
  interface RmrkTraitsPropertyPropertyInfo extends Struct {
    readonly key: Bytes;
    readonly value: Bytes;
  }

  /** @name PalletRmrkCoreError (625) */
  ...
  /** @name RmrkTraitsBaseBaseInfo (626) */
  ...
  /** @name PalletRmrkMarketListInfo (630) */
  ...
  /** @name PalletRmrkMarketOffer (632) */
  ...
  /** @name PalletRmrkMarketError (633) */
  ...
  /** @name PalletPhalaWorldPreorderInfo (634) */
  ...
  /** @name PalletPhalaWorldNftSaleInfo (636) */
  ...
  /** @name PalletPhalaWorldNftSalePalletError (637) */
  ...
  /** @name PalletPhalaWorldFoodInfo (638) */
  ...
  /** @name PalletPhalaWorldIncubationPalletError (643) */
  ...
  /** @name SpRuntimeMultiSignature (645) */
  ...
  /** @name SpCoreEd25519Signature (646) */
  interface SpCoreEd25519Signature extends U8aFixed {}

  /** @name SpCoreEcdsaSignature (647) */
  interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name FrameSystemExtensionsCheckNonZeroSender (650) */
  type FrameSystemExtensionsCheckNonZeroSender = Null;

  /** @name FrameSystemExtensionsCheckSpecVersion (651) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (652) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (653) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (656) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (657) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PhalaPalletsMqCheckSeqCheckMqSequence (658) */
  type PhalaPalletsMqCheckSeqCheckMqSequence = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (659) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name KhalaParachainRuntimeRuntime (660) */
