...
declare module '@polkadot/types/lookup' {
  ...
  interface PhalaPalletsComputeBasePoolPalletCall extends Enum {
    ...
    readonly isBackfillTransferShares: boolean;
    readonly asBackfillTransferShares: {
      readonly input: Vec<ITuple<[AccountId32, AccountId32, u64, u128, PhalaPalletsComputePoolProxyPoolType]>>;
    } & Struct;
    readonly type: 'AddStakerToWhitelist' | 'SetPoolDescription' | 'ResetLockIterPos' | 'RemoveUnusedLock' | 'RemoveStakerFromWhitelist' | 'BackfillTransferShares';
  }

  /** @name PhalaPalletsComputePoolProxyPoolType (345) */
  interface PhalaPalletsComputePoolProxyPoolType extends Enum {
    readonly isStakePool: boolean;
    readonly isVault: boolean;
    readonly type: 'StakePool' | 'Vault';
  }

  /** @name PalletUniquesCall (346) */
  ...
  /** @name PalletUniquesDestroyWitness (347) */
  ...
  /** @name RmrkTraitsResourceResourceInfoMin (352) */
  interface RmrkTraitsResourceResourceInfoMin extends Struct {
    readonly id: u32;
    readonly resource: RmrkTraitsResourceResourceTypes;
  }

  /** @name RmrkTraitsResourceResourceTypes (354) */
  ...
  /** @name RmrkTraitsResourceBasicResource (355) */
  interface RmrkTraitsResourceBasicResource extends Struct {
    readonly metadata: Bytes;
  }

  /** @name RmrkTraitsResourceComposableResource (356) */
  ...
  /** @name PalletPhalaWorldNftSalePalletCall (374) */
  ...
  /** @name SpCoreSr25519Signature (375) */
  interface SpCoreSr25519Signature extends U8aFixed {}

  /** @name PalletPhalaWorldStatusType (377) */
  ...
  /** @name PalletPhalaWorldIncubationPalletCall (378) */
  ...
  /** @name PalletBalancesReleases (466) */
  ...
  /** @name PalletTransactionPaymentReleases (469) */
  ...
  /** @name PalletAuthorshipUncleEntryItem (471) */
  ...
  /** @name PalletAuthorshipError (473) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (476) */
  interface PalletCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletCollatorSelectionError (478) */
  ...
  /** @name PalletDemocracyReferendumInfo (503) */
  ...
  /** @name PalletDemocracyReferendumStatus (504) */
  ...
  /** @name PalletDemocracyVoteVoting (506) */
  ...
  /** @name PalletDemocracyDelegations (510) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (511) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (515) */
  ...
  /** @name PalletCollectiveVotes (517) */
  ...
  /** @name PalletCollectiveError (518) */
  ...
  /** @name PalletTreasuryProposal (519) */
  ...
  /** @name PalletLotteryLotteryConfig (527) */
  ...
  /** @name PalletMembershipError (535) */
  ...
  /** @name PalletChildBountiesChildBounty (543) */
  ...
  /** @name PalletChildBountiesChildBountyStatus (544) */
  ...
  /** @name PalletChildBountiesError (545) */
  ...
  /** @name SubbridgePalletsChainbridgePalletProposalVotes (548) */
  ...
  /** @name SubbridgePalletsChainbridgePalletProposalStatus (549) */
  ...
  /** @name SubbridgePalletsChainbridgePalletBridgeEvent (551) */
  ...
  /** @name SubbridgePalletsChainbridgePalletError (553) */
  ...
  /** @name SubbridgePalletsXcmbridgePalletError (554) */
  ...
  /** @name SubbridgePalletsXtransferPalletError (555) */
  ...
  /** @name PhalaPalletsMqPalletError (557) */
  ...
  /** @name PhalaPalletsRegistryPalletWorkerInfoV2 (559) */
  ...
  /** @name PhalaPalletsRegistryPalletKnownConsensusVersion (561) */
  interface PhalaPalletsRegistryPalletKnownConsensusVersion extends Struct {
    readonly version: u32;
    readonly count: u32;
  }

  /** @name PhalaPalletsRegistryPalletError (562) */
  ...
  /** @name PhalaPalletsComputeComputationPalletSessionInfo (563) */
  ...
  /** @name PhalaPalletsComputeComputationPalletWorkerState (564) */
  ...
  /** @name PhalaPalletsComputeComputationPalletBenchmark (565) */
  ...
  /** @name PhalaPalletsComputeComputationPalletSessionStats (566) */
  interface PhalaPalletsComputeComputationPalletSessionStats extends Struct {
    readonly totalReward: u128;
  }

  /** @name PhalaPalletsComputeComputationPalletError (567) */
  ...
  /** @name PhalaPalletsStakePoolPalletPoolInfo (568) */
  ...
  /** @name PhalaPalletsStakePoolPalletWithdrawInfo (571) */
  ...
  /** @name PhalaPalletsStakePoolPalletUserStakeInfo (573) */
  ...
  /** @name PhalaPalletsStakePoolPalletError (576) */
  type PhalaPalletsStakePoolPalletError = Null;

  /** @name PalletAssetsAssetDetails (577) */
  ...
  /** @name RmrkTraitsNftRoyaltyInfo (619) */
  interface RmrkTraitsNftRoyaltyInfo extends Struct {
    readonly recipient: AccountId32;
    readonly amount: Permill;
  }

  /** @name RmrkTraitsResourceResourceInfo (621) */
  ...
  /** @name RmrkTraitsNftNftChild (624) */
  interface RmrkTraitsNftNftChild extends Struct {
    readonly collectionId: u32;
    readonly nftId: u32;
  }

  /** @name PhantomType (625) */
  interface PhantomType extends Vec<RmrkTraitsPropertyPropertyInfo> {}

  /** @name RmrkTraitsPropertyPropertyInfo (626) */
  interface RmrkTraitsPropertyPropertyInfo extends Struct {
    readonly key: Bytes;
    readonly value: Bytes;
  }

  /** @name PalletRmrkCoreError (628) */
  ...
  /** @name RmrkTraitsBaseBaseInfo (629) */
  ...
  /** @name PalletRmrkMarketListInfo (633) */
  ...
  /** @name PalletRmrkMarketOffer (635) */
  ...
  /** @name PalletRmrkMarketError (636) */
  ...
  /** @name PalletPhalaWorldPreorderInfo (637) */
  ...
  /** @name PalletPhalaWorldNftSaleInfo (639) */
  ...
  /** @name PalletPhalaWorldNftSalePalletError (640) */
  ...
  /** @name PalletPhalaWorldFoodInfo (641) */
  ...
  /** @name PalletPhalaWorldIncubationPalletError (646) */
  ...
  /** @name SpRuntimeMultiSignature (648) */
  ...
  /** @name SpCoreEd25519Signature (649) */
  interface SpCoreEd25519Signature extends U8aFixed {}

  /** @name SpCoreEcdsaSignature (650) */
  interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name FrameSystemExtensionsCheckNonZeroSender (653) */
  type FrameSystemExtensionsCheckNonZeroSender = Null;

  /** @name FrameSystemExtensionsCheckSpecVersion (654) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (655) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (656) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (659) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (660) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PhalaPalletsMqCheckSeqCheckMqSequence (661) */
  type PhalaPalletsMqCheckSeqCheckMqSequence = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (662) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name KhalaParachainRuntimeRuntime (663) */
