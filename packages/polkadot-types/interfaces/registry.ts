...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PhalaPalletsComputePoolProxyPoolType: PhalaPalletsComputePoolProxyPoolType;
