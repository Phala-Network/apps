export default {
  ...
  delegate: {
    ...
    delegated: 'Delegated',
    free_delegation: 'Free Delegation',
    releasing_stake: 'Releasing Stake',
    worker: 'Worker',
    actions: 'Actions',
    my_delegated: 'My delegated',
    your_delegated: 'Your delegated',
    your_withdrawing: 'Your withdrawing',
    claimable_rewards: 'Claimable Rewards',
    pool_remaining: 'Pool Remaining',
    delegable_balance: 'Delegable Balance',
    delegate: 'Delegate',
    delegate_some_stake_to_a_pool: 'Delegate some stake to a pool',
    amount: 'Amount',
    amount_pha: 'Amount (PHA)',
    please_reserve: 'Please reserve about 1 $PHA fee',
    claim: 'Claim',
    back: 'Back',
    withdraw: 'Withdraw',
  },
