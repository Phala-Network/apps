...
export type GetChainBridgeProposalEventsByDepositNonceQuery = {
  __typename?: 'Query'
  chainBridgeProposalApprovals?: Maybe<{
    __typename?: 'ChainBridgeProposalApprovalsConnection'
    nodes: Array<
      Maybe<{
        __typename?: 'ChainBridgeProposalApproval'
        ...
        approvalBlockHeight: string
        approvalExtrinsic: string
        signer: string
      }>
    >
  }>
  chainBridgeProposalExecutions?: Maybe<{
    __typename?: 'ChainBridgeProposalExecutionsConnection'
    nodes: Array<
      Maybe<{
        __typename?: 'ChainBridgeProposalExecution'
...
export const GetChainBridgeProposalEventsByDepositNonceDocument = gql`
  query getChainBridgeProposalEventsByDepositNonce(
    $originChainId: Int!
    ...
    chainBridgeProposalApprovals(
      filter: {
        and: [
          {
            depositNonce: {equalTo: $depositNonce}
            originChainId: {equalTo: $originChainId}
          }
        ]
      }
    ) {
...
export function getSdk(
  ...
  return {
    getChainBridgeProposalEventsByDepositNonce(
      variables: GetChainBridgeProposalEventsByDepositNonceQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetChainBridgeProposalEventsByDepositNonceQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetChainBridgeProposalEventsByDepositNonceQuery>(
            GetChainBridgeProposalEventsByDepositNonceDocument,
            variables,
